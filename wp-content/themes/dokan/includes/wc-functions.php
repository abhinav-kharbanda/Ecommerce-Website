 ...
 * @return void
 */
function dokan_child_process_location($post_id){                                                            //****************************  DOKAN-CHILD *************************
    delete_post_meta($post_id, 'location');
    foreach ($_POST['post_location'] as $loc) {
        $loc=strtolower(stripslashes(trim($loc)));
        add_post_meta($post_id, 'location', $loc);
    }
...
function dokan_process_product_meta( $post_id ) {
    ...
    dokan_child_process_location($post_id);                       //****************************  DOKAN-CHILD *************************
