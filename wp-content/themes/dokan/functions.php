       ...
       function scripts() {
           ...
           if (DOKAN_LOAD_SCRIPTS === true) {
               ...
               wp_localize_script('jquery', 'dokan', array(
                   ...
                   'ajax_loader' => THEMEROOT . '/images/ajax-loader.gif',
                   'seller' => array(
               ...
               wp_localize_script('dokan-scripts', 'dokan', array(         //*********************** EDITED DOKAN-CHILD jquery ==> dokan-scripts in wp_localize_script ***************
                   'ajaxurl' => admin_url('admin-ajax.php'),
                   'nonce' => wp_create_nonce('dokan_reviews'),
