...
class WC_Points_Rewards_Admin {
	...
	public function load_wc_scripts( $screen_ids ) {
		...
		// sub-menu page
		$screen_ids[] = 'woocommerce_page_wc_points_rewards';
	...
	public static function get_settings() {
		...
		$settings = array(
			...
			array(
				'title'    => __( 'Redeem Points Conversion Rate', 'wc_points_rewards' ),
	...
	public function handle_settings_actions() {
		...
		if ( 'points' == $current_tab ) {
			...
			} elseif ( $wc_points_rewards->admin_message_handler->message_count() > 0 || $wc_points_rewards->admin_message_handler->error_count() > 0 ) {
				// display the result
